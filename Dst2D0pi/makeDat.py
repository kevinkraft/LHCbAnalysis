...
ff = '/afs/cern.ch/user/k/kmaguire/cmtuser/DaVinciDev_v39r0p1/D0Lifetime/TupleMaking/magup_xrootd.txt'
treename = 'TeslaRSTuple/DecayTree'
fout = '/afs/cern.ch/user/k/kmaguire/Programs/KenzieAnalysisFork/Dst2D0pi/dat/may17_magup_full.dat'
itype = '130'
year = '2015'
name = 'Data'
sqrts = '13'
